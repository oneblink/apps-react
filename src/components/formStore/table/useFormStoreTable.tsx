...
export default function useFormStoreTable({
  ...
  React.useEffect(() => {
    ...
    // We cannot use form.id as a dependency here because it will cause table state
    // from the previous selected form to be set in local storage for the new form
